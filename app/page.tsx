...
const SECTIONS = [
  {
    ...
    label: "Professions",
    description:
      "Classes and paths available to characters, with features and abilities.",
    iconBg: "#DBEAFE",
    iconColor: "#1D4ED8",
    icon: (
      <svg
  ...
  },
  {
    ...
    label: "Origins",
    description:
      "Character backgrounds and vocations that shape who your character is.",
    iconBg: "#D1FAE5",
    iconColor: "#065F46",
    icon: (
      <svg
  ...
  },
  {
    ...
    label: "Spells",
    description:
      "Magical abilities organized by school, tier, and source tradition.",
    iconBg: "#F3E8FF",
    iconColor: "#7C3AED",
    icon: (
      <svg
  ...
  },
  {
    ...
    label: "Feats",
    description:
      "Special abilities earned through origins and profession advancement.",
    iconBg: "#FEF3C7",
    iconColor: "#B45309",
    icon: (
      <svg
  ...
  },
  {
    ...
    label: "Actions",
    description:
      "All available actions in combat and narrative scenes, grouped by type.",
    iconBg: "#FEE2E2",
    iconColor: "#B91C1C",
    icon: (
      <svg
    ...
    <div>
      ...
      <div style={{ marginBottom: "2.5rem" }}>
        ...
        >
          ...
          professions, spells, origins, feats, and more — all in one organized
          place.
        </p>
        <Link
          href="/search"
